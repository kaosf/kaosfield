...
Two middleware functions by default which are are located in the `kaosfield.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `kaosfield.handler` namespace to manage the enabled middleware.
